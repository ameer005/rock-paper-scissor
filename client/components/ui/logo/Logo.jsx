...
const Logo = () => {
  return (
    <div className="flex">
      <div className="rock-gradient relative mt-2 flex h-16 w-16  -rotate-12 items-center  justify-center  rounded-full">
      ...
      <div className="paper-gradient  relative z-10 -ml-4 flex h-16 w-16 items-center justify-center rounded-full">
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white py-2">
          <Image className="w-8" src={paperImg} alt="rock" priority={true} />
        </div>
      </div>
      <div className="scissor-gradient relative mt-2 -ml-4 flex h-16 w-16 rotate-12 items-center justify-center rounded-full">
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white py-2">
